...
def train(**kwargs):
    ...
    device = t.device('cuda') if opt.use_gpu else t.device('cup')
...
#   train
            ...
            # content loss
            content_loss = opt.content_weight * F.mse_loss(feature_y.relu2_2, feature_x.relu2_2)
